...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072198269417507246)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072198501691507246)
,p_plug_template_id=>wwv_flow_api.id(49072198269417507246)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072198806419507246)
,p_plug_template_id=>wwv_flow_api.id(49072198269417507246)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072199167891507246)
,p_plug_template_id=>wwv_flow_api.id(49072198269417507246)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072199474758507246)
,p_plug_template_id=>wwv_flow_api.id(49072198269417507246)
,p_name=>'Sub Regions'
