...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072194061986507245)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072194346203507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072194625988507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072194936859507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072195205730507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072195598828507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072195862200507245)
,p_plug_template_id=>wwv_flow_api.id(49072194061986507245)
,p_name=>'Sub Regions'
