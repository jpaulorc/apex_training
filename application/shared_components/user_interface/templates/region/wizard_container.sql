...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072237231456507259)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072237572854507259)
,p_plug_template_id=>wwv_flow_api.id(49072237231456507259)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072237813168507259)
,p_plug_template_id=>wwv_flow_api.id(49072237231456507259)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072238123520507260)
,p_plug_template_id=>wwv_flow_api.id(49072237231456507259)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072238451314507260)
,p_plug_template_id=>wwv_flow_api.id(49072237231456507259)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072238757670507260)
,p_plug_template_id=>wwv_flow_api.id(49072237231456507259)
