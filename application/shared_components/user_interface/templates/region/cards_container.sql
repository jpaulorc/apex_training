...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072173086248507238)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072173391672507238)
,p_plug_template_id=>wwv_flow_api.id(49072173086248507238)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072173685630507238)
,p_plug_template_id=>wwv_flow_api.id(49072173086248507238)
,p_name=>'Sub Regions'
