...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072216072106507252)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072216341905507252)
,p_plug_template_id=>wwv_flow_api.id(49072216072106507252)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072216645161507252)
,p_plug_template_id=>wwv_flow_api.id(49072216072106507252)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072216910964507252)
,p_plug_template_id=>wwv_flow_api.id(49072216072106507252)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072217297716507252)
,p_plug_template_id=>wwv_flow_api.id(49072216072106507252)
,p_name=>'Sub Regions'
