...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072229833898507257)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072230112314507257)
,p_plug_template_id=>wwv_flow_api.id(49072229833898507257)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072230424544507257)
,p_plug_template_id=>wwv_flow_api.id(49072229833898507257)
,p_name=>'Tabs'
