...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(49072217841330507253)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072218143515507253)
,p_plug_template_id=>wwv_flow_api.id(49072217841330507253)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072218454954507253)
,p_plug_template_id=>wwv_flow_api.id(49072217841330507253)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072218791026507253)
,p_plug_template_id=>wwv_flow_api.id(49072217841330507253)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072219062447507253)
,p_plug_template_id=>wwv_flow_api.id(49072217841330507253)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(49072219309181507253)
,p_plug_template_id=>wwv_flow_api.id(49072217841330507253)
,p_name=>'Sub Regions'
